...
const Research_p3 = () => {
    ...
    return (
        <Pdf_container>
            <Iframe_container>
                <iframe style={pdfStyle} src={require("../../assets/Research_p3.pdf")} frameborder="0"></iframe>
            </Iframe_container>
            <Pdf_download_container>
                <Pdf_download_link href={require("../../assets/Research_p3.pdf")} download="學年度參與展演活動學生人次">檔案下載</Pdf_download_link>
                <Pdf_download_icon />
            </Pdf_download_container>
        </Pdf_container>
