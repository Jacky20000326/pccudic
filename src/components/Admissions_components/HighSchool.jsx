...
const HighSchool = () => {
    return (
        <motion.div initial={{ opacity: 0, top: "-50%", y: 20 }} animate={{ opacity: 1, y: 0, }} exit={{ opacity: 1, scale: .8, y: 0 }} transition={{ duration: 0.3 }}>
            <Title>學系介紹</Title>
            <Context>
                &emsp;&emsp;資訊傳播學系在融媒體時代中架構新傳播學術與技術領域，以學群教學與專題製作讓學生從做中學並與產業提早互動，增加就業競爭力。本系依循產業需求，建構『數位內容創製』與『跨媒體資訊應用』兩大學群；透過跨領域學習與互動，培養數據分析、數位內容、數位遊戲、行動APP、媒體傳播、社群行銷與虛擬實境等產業前沿人才。
                <br />
                <br />
            ...
            <br />
            <Title>教學特色</Title>
            <Context> &emsp;&emsp;本系提供多元課程模組，運用多元教學方法以及多元評量於課程，結合新資訊媒體整合科技服務與人文傳播。配合教師專長建置實習研究環境，如虛擬實境與人機互動、數位影音、行動資訊服務、影像與色彩度量、多媒體與資訊設計、跨媒材加值技術、數位學習等研究室，提供專業儀器設備，結合專業師資，以滿足不同學生之學習需求。
            ...
            <br />
            <Title>課程重點</Title>
            <Context>&emsp;&emsp;大一基礎必修、大二專業必修、大三學群進階、大四畢業製作。
                透過學群分組以及畢業專題，落實學用合一，提升職場競爭。
                數位內容創製：攝影實務、音效與配樂、影音特效製作、互動多媒體設計、2D／3D動畫、數位插畫
                跨媒體資訊應用：虛擬實境、資訊視覺化、人機互動、行動APP、網站設計／資料庫、訊息介面設計
            </Context>
            <br />
            <br />
            <br />
            ...
            <br />
            <Title>教學資源</Title>
            <Context> &emsp;&emsp;本系所現有教學研究設備新穎充足，可充分提供同學們專業實習的機會，如網路資訊系統與行動平台研究室、影像與色彩度量研究室、3Ｄ虛擬實境與人機互動實驗室、多媒體與資訊設計研究室、跨媒材加值技術研究室、數位學習研究室、超媒體專案研究室、多媒體專業教室及數位影音製作研究室等。未來逐年持續更新採購先進教學研究設備，以期建置完整的資訊化、數位化及網路化的教學實習環境。
            ...
            <br />
            <Title>同學未來發展</Title>
            <Context>&emsp;&emsp;畢業生可從事資訊通訊傳播( I C T ) 產業與數位內容產業，包括媒體設計製作(形象設計、網頁設計、多媒體設計、人機介面設計等)、媒體企劃行銷、遊戲產業（遊戲企劃、製作與行銷）、資訊產業（含行動與網路資訊服務、程式開發、系統設計）、數位內容產製與營運、媒材創意加值服務、數位印刷複製服務、色彩暨資訊影像品質管制等。
            </Context>
            <br />
            <br />
            <br />
